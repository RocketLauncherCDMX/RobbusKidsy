...
//
// En este ejemplo aprenderemos a usar la funcion set para prender o apagar un LED. Tambien 
...
//
// Ejemplo:
// bool direccion = 0;      // variable direccion inicia en 0
...
void loop() {
  ...
  if(Kidsy.ButtonC.read() == PRESSED) {
    state_led3 = !state_led3;             // Cambia el valor de state_led3
  }
